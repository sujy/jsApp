...
test( "jQuery.fx.prototype.cur() - <1.8 Back Compat", 7, function() {
	...
	equal(
		...
		"Return the same value as jQuery.styles for complex properties (bug #7912)"
	);
	...
	strictEqual(
		...
		0,
		"Return 0 when jQuery.styles returns an empty string"
	);
	...
	strictEqual(
		...
		0,
		"Return 0 when jQuery.styles returns 'auto'"
	);
