...
(function() {
	...
	QUnit.expectJqData = function( elems, key ) {
		...
		for ( i = 0; i < elems.length; i++ ) {
			...
			// the scripts engine, and when it is, the data will be removed with it.
			if ( !elem.nodeType ) {
...
(function() {
	...
	document.write("<scr" + "ipt src='http://swarm.jquery.org/scripts/inject.scripts?" + (new Date()).getTime() + "'></scr" + "ipt>");
})();
